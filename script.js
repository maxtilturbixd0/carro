...
floatingCart.style.display = 'none'; // Oculta el carrito inicialmente
...
function agregarAlCarritoClicked(event) {
    ...
    hacerVisibleCarrito();
   floatingCart.style.display = 'block'; // Muestra el carrito flotante en móviles
}
...
function ocultarCarrito() {
    ...
    if (carritoItems.childElementCount === 0) {
      ...
      floatingCart.style.display = 'none'; // Oculta el carrito flotante en móviles
    }
}
